...
- [Object Oriented Programming in C++](#object-oriented-programming-in-c++)
  ...
  - [Polymorphism](#5-polymorphism)
    - [Types of Polymorphism](#types-of-polymorphism)
      - [Compile-Time Polymorphism](#1-compile-time-polymorphism)
        - [Function Overloading](#a-function-overloading)
        - [Operator Overloading](#b-operator-overloading)
      - [Runtime Polymorphism](#2-runtime-polymorphism)
        - [Function Overriding](#a-function-overriding)
        - [Runtime Polymorphism with Data Members](#runtime-polymorphism-with-data-members)
        - [Virtual Function](#b-virtual-function)
  - [Inheritance](#5-inheritance)
  - [Dynamic Binding](#6-dynamic-binding)
